...
namespace McWebsite.Domain.Common.Errors.SystemUnexpected
{
    public static partial class UnexpectedErrors
    {
        public static class Identity
        {
            ...
            public static Error UserNotFoundButShouldBeError => Error.Custom((int)CustomErrorsCodes.Codes.Identity,
                                                                             code: "SystemUnexpected.Identity.UserNotFoundButShouldBeError",
